          ...
          if(tarteaucitronCustomText !== ''){
            ...
            tarteaucitron.addInternalScript(pathToServices, '', function () {
                ...
                if (tarteaucitron.parameters.mandatory == true) {
                   ...
                   html += '   <div class="tarteaucitronName">';
                   html += '       <span class="tarteaucitronH3" role="heading" aria-level="3">' + tarteaucitron.lang.mandatoryText + '</span><br/>';
                   html += '       <span class="tarteaucitronListCookies" style="padding-left: 0;"><b style="font-weight: 600;">3 cookies d̩pos̩s</b> : has_js, tarteaucitron, cw_id.</span><br/>';
                   html += '       <span class="tarteaucitronListCookies" style="padding-left: 0;"><a href="/cookies#cookies-ob">En savoir plus sur les cookies essentiels</a>.</span><br/>';
                   html += '   </div>';
                ...
                if (tarteaucitron.parameters.highPrivacy && !tarteaucitron.parameters.AcceptAllCta) {
                    ...
                    html += '      <span class="tarteaucitronCog"></span> ' + tarteaucitron.lang.personalize;
                    html += '   </button>';

                    if (tarteaucitron.parameters.privacyUrl !== "") {
                        html += '   <button type="button" id="tarteaucitronPrivacyUrl">';
                        html += '     <span class="tarteaucitronLock"></span>  ' + tarteaucitron.lang.privacyUrl;
                        html += '   </button>';
                    }
...
(function () {
  ...
  tarteaucitron.init({
    ...
    "iconSrc": "data:image/png;base64,", /* Optionnal: URL or base64 encoded image */
